...
import { FaCrown } from 'react-icons/fa'; // Ícone upgrade
...
export default function DashboardPage() {
  ...
  const handleCardClick = (prompt: Prompt) => {
    if (!isElite && !unlockedPromptIds.has(prompt.id)) setPromptToUnlock(prompt);
    // Se for elite ou já desbloqueado, navegação vai pelo link do card
  };
